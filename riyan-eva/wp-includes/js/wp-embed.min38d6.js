            ...
            if (!/[^a-zA-Z0-9]/.test(t.secret)) {
              ...
              for (c = 0; c < s.length; c++)
                if (((r = s[c]), e.source === r.contentWindow)) {
                  ...
                  if ("link" === t.message)
                    if (((i = l.createElement("a")), (a = l.createElement("a")), (i.href = r.getAttribute("src")), (a.href = t.value), o.test(a.protocol))) if (a.host === i.host) if (l.activeElement === r) d.top.location.href = t.value;
                }
            }
      }),
      e)
