...
!(function (e, t) {
  ...
  var m,
    ...
    I =
      ...
      (C = g.indexOf("MSIE ") >= 0 || g.indexOf("Trident/index.html") >= 0),
      ...
      b.ios && b.osVersion && g.indexOf("Version/index.html") >= 0 && "10" === b.osVersion.split(".")[0] && (b.osVersion = g.toLowerCase().split("version/index-2.html")[1].split(" ")[0]),
  ...
  var ie = {
    ...
    oe = {
      ...
      onTouchStart: function (e) {
        ...
        i.$imageEl &&
          0 !== i.$imageEl.length &&
          (s.isTouched ||
            (I.android && e.preventDefault(), (s.isTouched = !0), (s.touchesStart.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX), (s.touchesStart.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY)));
      },
    ...
    fe = {
      setTranslate: function () {
        ...
        if (
          (i.css({ "-webkit-transform-origin": "50% 50% -" + l / 2 + "px", "-moz-transform-origin": "50% 50% -" + l / 2 + "px", "-ms-transform-origin": "50% 50% -" + l / 2 + "px", "transform-origin": "50% 50% -" + l / 2 + "px" }), d.shadow)
        )
