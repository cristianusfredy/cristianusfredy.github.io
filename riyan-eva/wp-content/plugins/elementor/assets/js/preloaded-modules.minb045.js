      ...
      class ImageCarousel extends elementorModules.frontend.handlers.SwiperBase {
        ...
        getSwiperSettings() {
          ...
          Object.keys(i)
            ...
            "yes" === e.autoplay && (o.autoplay = { delay: e.autoplay_speed, disableOnInteraction: "yes" === e.pause_on_interaction }),
            s ? ((o.effect = e.effect), "fade" === e.effect && (o.fadeEffect = { crossFade: !0 })) : (o.slidesPerGroup = +e.slides_to_scroll || 1),
    ...
    5363: (e, t) => {
      ...
      class Video extends elementorModules.frontend.handlers.Base {
        ...
        prepareYTVideo(e, t) {
          const s = this.getElementSettings(),
            i = {
              ...
              playerVars: { controls: s.controls ? 1 : 0, rel: s.rel ? 1 : 0, playsinline: s.play_on_mobile ? 1 : 0, modestbranding: s.modestbranding ? 1 : 0, autoplay: s.autoplay ? 1 : 0, start: s.start, end: s.end },
            };
        ...
        onInit() {
          ...
          const e = this.getElementSettings();
          if (
            (elementorFrontend.utils[e.video_type] ? (this.apiProvider = elementorFrontend.utils[e.video_type]) : (this.apiProvider = elementorFrontend.utils.baseVideoLoader),
            "youtube" === e.video_type && ((this.videoID = this.apiProvider.getVideoIDFromURL(e.youtube_url)), this.videoID && (!e.show_image_overlay || !e.image_overlay.url)))
          )
            return e.lazy_load
              ? ((this.intersectionObserver = elementorModules.utils.Scroll.scrollObserver({
                  callback: (e) => {
      ...
      e.exports = elementorModules.ViewModule.extend({
        ...
        createLightbox: function (e) {
          ...
          if (!e.dataset.elementorLightboxSlideshow) {
            const t = "single-img";
            return void this.showModal({ type: "image", id: t, url: e.href, title: e.dataset.elementorLightboxTitle, description: e.dataset.elementorLightboxDescription, modalOptions: { id: "elementor-lightbox-slideshow-" + t } });
          }
        ...
        setVideoContent: function (e) {
          ...
          if ("hosted" === e.videoType) {
            ...
            -1 !== e.url.indexOf("vimeo.com") ? (s = elementorFrontend.utils.vimeo) : e.url.match(/^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/) && (s = elementorFrontend.utils.youtube),
        ...
        getShareLinks: function () {
          const { i18n: e } = elementorFrontend.config,
            t = { facebook: e.shareOnFacebook, twitter: e.shareOnTwitter, pinterest: e.pinIt },
            s = jQuery,
            ...
            l ||
              o.append(
                s("<a>", { href: d, download: "" })
                  ...
                  .prepend(s("<i>", { class: "eicon-download-bold", "aria-label": e.download }))
              ),
            o
          );
        },
        ...
        getSlideshowHeader: function () {
          const { i18n: e } = elementorFrontend.config,
            ...
            n = "yes" === elementorFrontend.getKitSettings("lightbox_enable_zoom"),
          ...
          if (s || i || n || o) {
            ...
            return (
              n &&
                ((l.$iconZoom = t("<i>", { class: r.iconZoomIn, role: "switch", "aria-checked": !1, "aria-label": e.zoom })),
                l.$iconZoom.on("click", this.toggleZoomMode),
                l.$header.append(l.$iconZoom),
                (this.$buttons = this.$buttons.add(l.$iconZoom))),
              i &&
                ((l.$iconExpand = t("<i>", { class: r.iconExpand, role: "switch", "aria-checked": !1, "aria-label": e.fullscreen }).append(t("<span>"), t("<span>"))),
                l.$iconExpand.on("click", this.toggleFullscreen),
                l.$header.append(l.$iconExpand),
                (this.$buttons = this.$buttons.add(l.$iconExpand))),
              s && ((l.$counter = t("<span>", { class: r.counter })), l.$header.append(l.$counter)),
              l.$header
            );
          }
        },
        ...
        setSlideshowContent: function (e) {
          const { i18n: t } = elementorFrontend.config,
            ...
            o = "" !== elementorFrontend.getKitSettings("lightbox_description_src"),
            a = n || o,
          ...
          e.slides.forEach((e) => {
            ...
            i ||
              ((h = s("<div>", { class: l.prevButton + " " + r.preventClose, "aria-label": t.previous }).html(s("<i>", { class: l.prevButtonIcon }))),
              (u = s("<div>", { class: l.nextButton + " " + r.preventClose, "aria-label": t.next }).html(s("<i>", { class: l.nextButtonIcon }))),
              d.append(u, h),
              (this.$buttons = this.$buttons.add(u).add(h))),
            a && ((this.elements.$footer = this.getSlideshowFooter()), d.append(this.elements.$footer)),
        ...
        playSlideVideo: function () {
          ...
          i.append(n),
            e.append(i),
            -1 !== t.indexOf("vimeo.com") ? ((a = "vimeo"), (r = elementorFrontend.utils.vimeo)) : t.match(/^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/) && ((a = "youtube"), (r = elementorFrontend.utils.youtube));
        ...
        openSlideshow: function (e, t) {
          ...
          s.each(function () {
            ...
            this.showModal({ type: "slideshow", id: e, modalOptions: { id: "elementor-lightbox-slideshow-" + e }, slideshow: { slides: i, swiper: { initialSlide: +n } } });
        },
