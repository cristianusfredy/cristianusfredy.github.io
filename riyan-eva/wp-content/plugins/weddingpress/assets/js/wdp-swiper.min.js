!(function (e, t) {
  ...
  var u = {
    ...
    A =
      ...
      (z = y.indexOf("MSIE ") >= 0 || y.indexOf("Trident/index.html") >= 0),
      (k = y.indexOf("Edge/index.html") >= 0),
      ($ = y.indexOf("Gecko/index.html") >= 0 && y.indexOf("Firefox/index.html") >= 0),
      (L = "Win32" === w),
      (I = y.toLowerCase().indexOf("electron") >= 0),
      (D = "MacIntel" === w),
      !C && D && h.touch && ((1024 === E && 1366 === T) || (834 === E && 1194 === T) || (834 === E && 1112 === T) || (768 === E && 1024 === T)) && ((C = y.match(/(Version)\/([\d.]+)/)), (D = !1)),
      (x.ie = z),
      (x.edge = k),
      (x.firefox = $),
      ...
      x.ios && x.osVersion && y.indexOf("Version/index.html") >= 0 && "10" === x.osVersion.split(".")[0] && (x.osVersion = y.toLowerCase().split("version/index-2.html")[1].split(" ")[0]),
    ...
    se = {
      handle: function (e) {
        ...
        if (!(s.shiftKey || s.altKey || s.ctrlKey || s.metaKey || (i.activeElement && i.activeElement.nodeName && ("input" === i.activeElement.nodeName.toLowerCase() || "textarea" === i.activeElement.nodeName.toLowerCase())))) {
          ...
          this.isHorizontal()
            ? ((o || l || d || h) && (s.preventDefault ? s.preventDefault() : (s.returnValue = !1)), (((l || h) && !t) || ((o || d) && t)) && this.slideNext(), (((o || d) && !t) || ((l || h) && t)) && this.slidePrev())
            : ((o || l || p || c) && (s.preventDefault ? s.preventDefault() : (s.returnValue = !1)), (l || c) && this.slideNext(), (o || p) && this.slidePrev()),
    ...
    xe = {
      init: function () {
        ...
        e.swiper instanceof t
          ? ((this.thumbs.swiper = e.swiper), d.extend(this.thumbs.swiper.originalParams, { watchSlidesProgress: !0, slideToClickedSlide: !1 }), d.extend(this.thumbs.swiper.params, { watchSlidesProgress: !0, slideToClickedSlide: !1 }))
