        ...
        constructor(...e) {
          super(...e),
            ...
            (this.config.legacyMode = {
              get elementWrappers() {
                return (
                  elementorFrontend.isEditMode() && elementorCommon.helpers.hardDeprecated("elementorFrontend.config.legacyMode.elementWrappers", "3.1.0", "elementorFrontend.config.experimentalFeatures.e_dom_optimization"),
    ...
    7139: (e, t) => {
      ...
      class SwiperBC {
        ...
        createSwiperInstance(e, t) {
          return (
            !SwiperBC.isSwiperLoaded && elementorFrontend.config.experimentalFeatures.e_optimized_assets_loading && ((n = window.Swiper), (SwiperBC.isSwiperLoaded = !0), legacySwiper()),
